...
(def lib 'com.github.brettatoms/zodiac-hot-reload)
...
(defn- pom-template [version]
  [[:description "A Zodiac extension for hot reload of server-rendered applications"]
   [:url "https://github.com/brettatoms/zodiac-hot-reload"]
   [:licenses
    [:license
     [:name "MIT License"]
   ...
   [:scm
    [:url "https://github.com/brettatoms/zodiac-hot-reload"]
    [:connection "scm:git:https://github.com/brettatoms/zodiac-hot-reload.git"]
    [:developerConnection "scm:git:ssh:git@github.com:brettatoms/zodiac-hot-reload.git"]
    [:tag (str "v" version)]]])
